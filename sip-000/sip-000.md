...
Recommended before it can be Ratified. Moving a SIP into this state may done
...
The initial Steering Committee will be determined at a future date before the
launch of the Stacks blockchain’s mainnet (see the “Activation” section).  Both
Blockstack PBC and the Stacks Open Internet Foundation shall select their
representatives in a manner of their choosing, and these two representatives
shall devise and provide a way for the community representative to be selected
(with the advice from public comments from the user community).
...
an Consideration Advisory Board concurrently with serving on the SC, unless
...
SIP Editors are concerned with shepharding SIPs from Draft
...
Public Venues for Conducting Business TODO: describe repositories, forum,
mailing lists, and PR flow
...
- The initial Steering Committee must be formed.
- A mailing list for the Steering Committee must be created.
